...
st.sidebar.selectbox("Choose option",["Option 1","Option2","Option3"])
...
with st.form("myform"):
    ...
    biography=st.text_input("Short Bio")

    terms=st.checkbox("I agreee")

    submit_button=st.form_submit_button(label="Sumbit")